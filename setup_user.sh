...
echo "alias r=\"date; $SUPPORT/reset_live.sh\"" >> ~/.bashrc
echo 'alias k="date; echo -en \\\x1Bp0~~ >/dev/ttyS1"' >> ~/.bashrc
echo 'alias kk="date; echo -en \\\x10\\\x14\\\x01\\\x00\\\x08 >/dev/ttyS1"' >> ~/.bashrc
